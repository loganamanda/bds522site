...
The given analysis looked at two datasets which are available through the links which are given on the introduction page. A few limitations to this particular analysis would be time to explore more variables throughout the given data. Given more time, the analysis could be far greater and compare more variables against different crimes committed, different years, and potentially adding in whether the individual who was stopped, had a weapon on them or not. The list of other variables to include are far greater than which was analyzed. Another piece that may be looked at in the future, is the demographics and neighborhood areas which make up the individual precincts to compare those inferences to the actual numbers which are produced in the regressions. 

**Concluding Remarks** 

Over the previous years the media coverage on racial discrimination by police officers has increased. But, there are also other factors which seem to show relevance for targeting in reference to this data analysis in terms for stops and frisks in New York City in 2010/2011. Connections with females, young adults, race, etc. can be analyzed with crime rates of previous years which essentially can cause the increase of targeting in certain neighborhoods or areas. This could be correlational because the crimes are occuring in that area or the officers could be targeting assuming that persons who fit a particular suspect, are going to eventually commit a crime. 
